...
- **DO NOT include any OpenCode footer or co-authorship attribution**
...
- **NO OpenCode footer**: Do not add any attribution or generated-by footer
...
- PR #123: dot-agent-opencode-folder-support (new)
- PR #122: base-branch (updated)

Current stack:
◯ dot-agent-opencode-folder-support (current)
◯ base-branch
◉ main
\`\`\`
```
